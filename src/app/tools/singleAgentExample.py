...
# Use ai.azure.com scope for Azure AI Foundry endpoints,
# or cognitiveservices.azure.com for direct Azure OpenAI endpoints.
# token_provider = get_bearer_token_provider(
#     credential,
#     "https://cognitiveservices.azure.com/.default"
#     if (endpoint or "").endswith("openai.azure.com/")
#     or "openai.azure.com" in (endpoint or "")
#     else "https://ai.azure.com/.default"
# )
client = AzureOpenAI(
